...
export default function Menu() {
  ...
  const orderWhatsApp = (item: any) => {
    const message = `Halo! Saya ingin memesan ${item.name} seharga ${item.price}. Terima kasih!`
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-400 to-purple-500 text-white p-6 rounded-lg text-center">
              ...
              <p className="text-purple-100 mb-4">6 donat + 2 minuman hanya Rp 45.000</p>
              <button className="bg-white text-purple-500 px-4 py-2 rounded-full font-semibold hover:bg-purple-50 transition-colors">
                Pesan Paket
              </button>
            </div>
          </div>
